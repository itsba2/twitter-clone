...
const SVG = ({ children, iconDesign }) => {
  return (
    <svg viewBox="0 0 24 24" className={`fill-current ${iconDesign}`}>
      {children}
    </svg>
  );
};

export const TwitterIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const HomeIconActive = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const HomeIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const ExploreIconActive = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const ExploreIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const NotificationsIconActive = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const NotificationsIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const MessagesIconActive = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const MessagesIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const BookmarksIconActive = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const BookmarksIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const ListsIconActive = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const ListsIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const ProfileIconActive = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const ProfileIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const MoreIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const DotDotDotIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const MediaIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const GIFIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const PollIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const EmojiIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
        <path d="M12 22.75C6.072 22.75 1.25 17.928 1.25 12S6.072 1.25 12 1.25 22.75 6.072 22.75 12 17.928 22.75 12 22.75zm0-20C6.9 2.75 2.75 6.9 2.75 12S6.9 21.25 12 21.25s9.25-4.15 9.25-9.25S17.1 2.75 12 2.75z"></path>
...
export const ScheduleIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const LocationIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const TopTweetsIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const ReplyIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const RetweetIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const LikeIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const LikedIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const ShareIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const SearchIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
...
export const VerifiedIcon = ({ iconDesign }) => {
  return (
    <SVG iconDesign={iconDesign}>
      <g>
